...
Source0  : https://github.com/rpm-software-management/libdnf/archive/0.71.0/libdnf-0.71.0.tar.gz
...
%prep
%setup -q -n libdnf-0.71.0
cd %{_builddir}/libdnf-0.71.0
%patch -P 1 -p1
%patch -P 2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697585517
mkdir -p clr-build
pushd clr-build
